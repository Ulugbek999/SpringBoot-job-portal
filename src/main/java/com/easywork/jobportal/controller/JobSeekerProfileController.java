...
public class JobSeekerProfileController {
    ...
    @GetMapping("/")
    public String JoSeekerProfile(Model model){
    ...
    public String addNew(JobSeekerProfile jobSeekerProfile,
        ...
        if(!(authentication instanceof AnonymousAuthenticationToken)){
            Users user = usersRepository.findByEmail(authentication.getName()).orElseThrow(() -> new UsernameNotFoundException("Username not found"));
